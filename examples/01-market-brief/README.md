...
**Goal:** turn a raw product README into a committed, polished one-page market
brief — research → decision → deliverable.

**Input:** `file` source pointing at Kondi's own README, with instructions to
ground all analysis in the actual product.
